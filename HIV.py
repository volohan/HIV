...
def f4(t, u_1, u_2, T_1, T_2, I_1, I_2, V, E):
    return (1 - f * u_2) * k_2 * V * T_2 - delta * I_2 - m_2 * E * I_2
...
# функция правой части дифференциального уравнения (y' = f(x, y))
def f1(t, T_1, T_2, I_1, I_2, V, E):
    return lambda_1 - d_1 * T_1 - (1 - 0.7) * k_1 * V * T_1


def f2(t, T_1, T_2, I_1, I_2, V, E):
    return lambda_2 - d_2 * T_2 - (1 - f * 0.7) * k_2 * V * T_2


def f3(t, T_1, T_2, I_1, I_2, V, E):
    return (1 - 0.7) * k_1 * V * T_1 - delta * I_1 - m_1 * E * I_1


def f4(t, T_1, T_2, I_1, I_2, V, E):
    return (1 - f * 0.7) * k_2 * V * T_2 - delta * I_2 - m_2 * E * I_2


def f5(t, T_1, T_2, I_1, I_2, V, E):
    return (1 - 0.3) * N_T * delta * (I_1 + I_2) - c * V - (
                (1 - 0.7) * ro_1 * k_1 * T_1 + (
                    1 - f * 0.7) * ro_2 * k_2 * T_2) * V


def f6(t, T_1, T_2, I_1, I_2, V, E):
    return lambda_E + (b_E * (I_1 + I_2)) / ((I_1 + I_2) + K_b) * E - (
                d_E * (I_1 + I_2)) / ((I_1 + I_2) + K_d) * E - delta_E * E


x, y = RK4([f1, f2, f3, f4, f5, f6], start, t0, tn, h)
